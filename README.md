...
Note:	If you install DKMS on a 4.4.x-x-generic kernel such as 4.4.0-31-generic it will work but:

	* it will break on update to 4.4.0-87,88,89-generic kernels so it's best to go to HWE 4.10 HWE kernel on 16.04 
